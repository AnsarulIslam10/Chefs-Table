const Banner = () => {
    return (
        <div className="bg-cover bg-no-repeat rounded-3xl md:w-full h-full md:h-[35.5rem] mb-10" style={{ backgroundImage: 'url(https://i.ibb.co.com/6t7DG5D/Chef-banner.png)' }}>
            ...
            <div className="w-9/12 mx-auto flex flex-col justify-center items-center text-center h-full space-y-6 py-4">
                ...
                <div className="flex gap-4 text-xl font-semibold">
                    ...
                    <button className="btn btn-outline text-white hover:bg-green-400 rounded-full border">Our Feedback</button>
                </div>
            </div>
        </div>
    );
